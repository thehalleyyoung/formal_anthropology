...
\input{tex_v2_chapters/mg_ch1_7}

%==========================================================================
\part{Dynamic and Evolutionary Games}
%==========================================================================

\input{tex_v2_chapters/mg_ch8_14}

%==========================================================================
\part{Advanced Topics and Open Problems}
%==========================================================================

\input{tex_v2_chapters/mg_ch15_21}

%==========================================================================
\part{Deep Structures and Grand Unification}
%==========================================================================

\input{tex_v2_chapters/mg_deep}
...
\item Myerson, R., ``Optimal Auction Design,'' \emph{Mathematics of Operations Research} 6(1), 1981.
\item Myerson, R.\ and Satterthwaite, M., ``Efficient Mechanisms for Bilateral Trading,'' \emph{Journal of Economic Theory} 29(2), 1983.
\item Nash, J., ``Non-Cooperative Games,'' \emph{Annals of Mathematics} 54(2), 1951.
\item Nemhauser, G., Wolsey, L., and Fisher, M., ``An Analysis of Approximations for Maximizing Submodular Set Functions,'' \emph{Mathematical Programming} 14, 1978.
...
\item Rappaport, R.A., \emph{Ritual and Religion in the Making of Humanity}, Cambridge, 1999.
\item Ricoeur, P., \emph{Interpretation Theory}, TCU Press, 1976.
\item Roughgarden, T.\ and Tardos, E., ``How Bad is Selfish Routing?,'' \emph{Journal of the ACM} 49(2), 2002.
...
\item Tononi, G., ``Consciousness as Integrated Information: A Provisional Manifesto,'' \emph{Biological Bulletin} 215(3), 2008.
\item Green, J.\ and Laffont, J.-J., ``Characterization of Satisfactory Mechanisms for the Revelation of Preferences for Public Goods,'' \emph{Econometrica} 45(2), 1977.
\item Kamenica, E.\ and Gentzkow, M., ``Bayesian Persuasion,'' \emph{American Economic Review} 101(6), 2011.
\item Maynard Smith, J., \emph{Evolution and the Theory of Games}, Cambridge, 1982.
\item Milgrom, P.\ and Roberts, J., ``Rationalizability, Learning, and Equilibrium in Games with Strategic Complementarities,'' \emph{Econometrica} 58(6), 1990.
\item Milgrom, P.\ and Weber, R., ``A Theory of Auctions and Competitive Bidding,'' \emph{Econometrica} 50(5), 1982.
