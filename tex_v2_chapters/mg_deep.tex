...
\label{cor:grand-coalition-political}
...
ratchet (Theorem~\ref{thm:poetic-weight-ratchet} from Chapter~15).
...
\label{thm:meaning-is-use-synthesis}
...
\label{def:form-of-life-synthesis}
...
\begin{enumerate}
  \item Meaning is the use-profile $\mathcal{U}_a$
    (Theorem~\ref{thm:meaning-is-use-synthesis}).
  \item Meaning is resonance structure, not mental content
    (direct consequence of Theorem~\ref{thm:meaning-is-use-synthesis}).
...
Theorem~\ref{thm:meaning-is-use-synthesis} (meaning is use-profile).
...
$\longleftrightarrow$ Theorem~\ref{thm:meaning-is-use-synthesis} (corollary).
