...
\label{thm:repeated-weight-ratchet}
...
(Theorem~\ref{thm:repeated-weight-ratchet}).
\end{proof}
...
\emph{increasing} in $k$ because the punisher's weight grows during
       punishment (Theorem~\ref{thm:repeated-weight-ratchet}), making punishment more severe.
...
\begin{itemize}
  ...
  \item \textbf{Coalition value} for an ordered subset
        ...
        \[
          ...
          = \rs\!\left(a_{i_1} \compose a_{i_2} \compose \cdots \compose a_{i_k},\;
                       a_{i_1} \compose a_{i_2} \compose \cdots \compose a_{i_k}\right).
        \]
  \item $v(\emptyset) := 0$.
\end{itemize}
\end{definition}
...
\label{thm:coalition-enrichment-ordered}
...
\label{cor:grand-coalition-ordered}
...
\begin{proof}
Apply Theorem~\ref{thm:coalition-enrichment-ordered} repeatedly: extend the
...
\label{thm:attribution-impossibility-ordered}
...
(Theorem~\ref{thm:coalition-enrichment-ordered}), the core is non-empty.
\end{theorem}
...
But the weight ratchet (Theorem~\ref{thm:repeated-weight-ratchet}) poses a challenge
...
coalition dominance theorem (Corollary~\ref{cor:grand-coalition-ordered}), this is
